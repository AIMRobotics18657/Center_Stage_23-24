...
public final class BlueCameraDrop extends LinearOpMode {
    Robot robot = new Robot(true, new Pose2d(AutoConstants.CAMERA_DROP_START_X, AutoConstants.CAMERA_DROP_BLUE_START_Y, AutoConstants.CAMERA_DROP_BLUE_START_HEADING), true);
    int randomization = 1;
