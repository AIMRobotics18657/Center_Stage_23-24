...
public class FinalsAutoConstants {
    ...
    public static final Pose2d P_DROP_RED_2_A = new Pose2d(-36, -37, Math.toRadians(90));
    ...
    public static final Pose2d P_DROP_BLUE_2_A = new Pose2d(-36, 37, Math.toRadians(270));
    public static final double P_DROP_BLUE_2_A_TANGENT = Math.toRadians(90);
    public static final Pose2d P_DROP_BLUE_3_A = new Pose2d(-46, 42, Math.toRadians(270));
    ...
    public static final Vector2d P_DROP_RED_1_A_CLOSE = new Vector2d(40, -40);
    public static final Pose2d P_DROP_RED_1_B_CLOSE = new Pose2d(35.5, -37, Math.toRadians(180));
    public static final double P_DROP_RED_1_B_TANGENT_CLOSE = Math.toRadians(0);
    public static final Pose2d P_DROP_RED_2_A_CLOSE = new Pose2d(36, -37, Math.toRadians(90));
    public static final double P_DROP_RED_2_A_TANGENT_CLOSE = Math.toRadians(90);
    public static final Pose2d P_DROP_RED_3_A_CLOSE = new Pose2d(46, -42, Math.toRadians(90));
    public static final double P_DROP_RED_3_A_TANGENT_CLOSE = Math.toRadians(90);

    public static final Pose2d P_DROP_BLUE_1_A_CLOSE = new Pose2d(46, 42, Math.toRadians(270));
    public static final double P_DROP_BLUE_1_A_TANGENT_CLOSE = Math.toRadians(90);
    public static final Pose2d P_DROP_BLUE_2_A_CLOSE = new Pose2d(36, 37, Math.toRadians(270));
    public static final double P_DROP_BLUE_2_A_TANGENT_CLOSE = Math.toRadians(90);
    public static final Vector2d P_DROP_BLUE_3_A_CLOSE = new Vector2d(40, 40);
    public static final Pose2d P_DROP_BLUE_3_B_CLOSE = new Pose2d(35.5, 37, Math.toRadians(180));
    public static final double P_DROP_BLUE_3_B_TANGENT_CLOSE = Math.toRadians(0);
