...
public final class CloseBlueAwayPark extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            Action driveToPark = robot.drivebase.drive.actionBuilder(new Pose2d(yellowDropSpot, FinalsAutoConstants.PIXEL_BOARD_HEADING))
                    ...
                    .strafeToLinearHeading(FinalsAutoConstants.PARK_BLUE_AWAY.position, FinalsAutoConstants.PARK_BLUE_AWAY.heading)
                    .build();
